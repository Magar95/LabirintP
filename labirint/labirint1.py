...
class GameSprite(sprite.Sprite):
    ...
    def __init__(self, player_image, player_x, player_y, size_x, size_y):
        ...
        self.image = transform.scale(image.load(player_image), (size_x,
            size_y))
...
class Player(GameSprite):
    def __init__(self, player_image, player_x, player_y, size_x,
        size_y, player_x_speed, player_y_speed):

        GameSprite.__init__(self, player_image, player_x,
            player_y, size_x, size_y)
